...
(*ing_t_p*) para cada versión. Esta tabla debe ser construida a nivel persona, utilizando el factor de
expansión (*fact_cal_esi*).
...
de algunas estrategias. Utiliza el paquete `microbenchmark`, cuyo uso básico se describe aquí.
